function createDataset(fields, constraints, sortFields) {
	log.info("arquivo_consulta_taxonomia_compl - INICIO ##########");
...
function montaBusca(constraints){
	log.info("arquivo_consulta_taxonomia_compl - montaBusca - constraints: ");
	log.dir(constraints);
	
	var select = "SELECT * FROM VIEW_ARQ_TAXONOMIA pai ";
	select += " INNER JOIN VIEW_ARQ_TAXONOMIA_ESTR filho ON pai.id = filho.masterid "
