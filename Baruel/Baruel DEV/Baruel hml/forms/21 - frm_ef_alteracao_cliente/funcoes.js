...
function atribuiValoresReadOnly(){
	...
	const COD_CLIENTE_READONLY = $('#A1_COD').val();
	const LOJA_READONLY = $('#A1_LOJA').val();
	const NOME_READONLY = $('#A1_NOME').val();
	const CNPJ_READONLY = $('#A1_CGC').val();

	$('#COD_CLIENTE_READONLY').val(COD_CLIENTE_READONLY);
