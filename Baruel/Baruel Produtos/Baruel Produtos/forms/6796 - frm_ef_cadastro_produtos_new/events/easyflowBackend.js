...
function setupGroupsFromError(form) {
    setupGroups(form);

    // Atualiza o grupo atual para caso de "transferir"
    var grupoAtual = form.getValue("grupoAtual");
    form.setValue("proximoGrupo", grupoAtual);
}
