...
function createDataset(fields, constraints, sortFields) {
	log.info("arquivo_kpi_expirados - INICIO ##########");
...
DatasetFactory.getDataset('arquivo_kpi_expirados',[],cs,[]);
 */
function montaBusca(constraints){
	log.info("arquivo_kpi_expirados - montaBusca - constraints: ");
	log.dir(constraints);
	...
	//Para teste, sem agrupamento
	//var select = "SELECT et.*, dDocumento.dt_expiracao, CURDATE() as hoje ";
