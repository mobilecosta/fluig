var WidgetNotas = SuperWidget.extend({
	...
	loadingFuncao: null,
	sessao : null,
	pastaTemporaria: 10782136,
	tipoLabelStatus : {
		"Processo cancelado" : "danger",
		"Pendente anexar a nota fiscal" : "primary",
		"Processando pagamento" : "info",
		"Processo finalizado" : "success",
		"Verificar Inconsistencias" : "warning"
	},
//PARA MUDAR A COR DO STATUS https://style.fluig.com/components.html#labels
	init: function() {
		if(!this.isEditMode) {
	...
	abrirModalAnexo: function(elemento) {
		...
		this.modalAnexo = FLUIGC.modal({
			...
			if(localizacao == "Verificar Inconsistencias" && observacao != "")
